 ...
 * 
 *  This example will read the MASS / VOC values and allows to change the VOC algorithm parameters
 *  
...
void setup() {
  ...
  serialTrigger((char *) "SEN6x-Example5: Display basic values and get/set VOC Algorithm. press <enter> to start");
