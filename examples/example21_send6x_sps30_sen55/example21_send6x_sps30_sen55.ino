 ...
 *  
 *  Tested on UNO R4
 *  As the SEN6x is 3V3 we connect to Qwicc/STEMMA I2C, the SPS30 serial and the SEN55 to (5v) wire. 
 *  
...
void setup() {
  ...
  serialTrigger((char *) "Example21: SEN6x, SEN55 and SPS30. Press <enter> to start");
